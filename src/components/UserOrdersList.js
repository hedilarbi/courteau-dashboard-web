    ...
    <div className="bg-white shadow-default rounded-xl mt-4 font-roboto border border-gray-100 overflow-hidden">
      {orders.length > 0 ? (
        <div className="overflow-x-auto">
          <div className="min-w-[900px] h-[500px] flex flex-col">
            <div className="grid grid-cols-[1.6fr,1fr,1fr,1fr,1fr,1fr] bg-gray-50 text-xs uppercase tracking-wide text-text-light-gray px-4 py-3">
              <span>Date</span>
              <span>Statut</span>
              <span>Code</span>
              <span>Type</span>
            ...
            <div className="flex-1 overflow-y-auto divide-y divide-gray-100">
              {orders.map((order, index) => (
                <div
                  key={index}
                  className="grid grid-cols-[1.6fr,1fr,1fr,1fr,1fr,1fr] items-center px-4 py-3 text-sm text-text-dark-gray hover:bg-gray-50 transition"
                >
