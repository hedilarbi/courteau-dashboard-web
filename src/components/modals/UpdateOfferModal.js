...
const UpdateOfferModal = ({ setShowUpdateOfferModal, setOffers, offer }) => {
  ...
  const updateOffer = async () => {
    ...
    try {
      const response = await fetch(`${API_URL}/offers/update/${offer._id}`, {
        method: "PUT",
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-sm text-text-light-gray">
                Mettez à jour l&apos;image, le prix et les articles inclus.
              </p>
            </div>
            <button
